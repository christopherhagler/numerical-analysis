...
static void test_secant_cubic(void **state) {
    (void)state; // Unused
    float root = root_secant(RootFinder_Cubic, 1.0, 2.0, 1e-6);
...
static void test_secant_quadratic(void **state) {
    (void)state; // Unused
    float root = root_secant(RootFinder_Quadratic, 0.0, 2.0, 1e-6);
    assert_false(isnan(root));
...
static void test_secant_sin(void **state) {
    (void)state; // Unused
    float root = root_secant(RootFinder_Sine, 0.0, 2.0, 1e-6);
    assert_false(isnan(root));
...
static void test_secant_logarithm(void **state) {
    (void)state; // Unused
    float root = root_secant(RootFinder_Logarithmic, 1.0, 3.0, 1e-6);
    assert_false(isnan(root));
...
static void test_secant_positive_quadratic(void **state) {
    (void)state; // Unused
    float root = root_secant(PositiveQuadratic, -2.0, 2.0, 1e-6);
    assert_true(isnan(root));
}

static void test_secant_invalid_interval(void **state) {
    (void)state; // Unused
    float root = root_secant(RootFinder_Quadratic, 1.0, 1.0, 1e-6);
    assert_true(isnan(root));
}

static void test_secant_no_root(void **state) {
    (void)state; // Unused
    float root = root_secant(ConstantFunc, 5.0, 6.0, 1e-6);
    assert_true(isnan(root));
}