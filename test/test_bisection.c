...
static void test_function1_root(void **state) {
    (void)state; // Unused
    float root = root_bisection(function1, 1.0, 2.0, 1e-6);
...
static void test_function2_root(void **state) {
    (void)state; // Unused
    float root = root_bisection(function2, 0.0, 2.0, 1e-6);
    assert_false(isnan(root));
...
static void test_function3_root(void **state) {
    (void)state; // Unused
    float root = root_bisection(function3, 0.0, 2.0, 1e-6);
    assert_false(isnan(root));
...
static void test_function4_root(void **state) {
    (void)state; // Unused
    float root = root_bisection(function4, 1.0, 3.0, 1e-6);
    assert_false(isnan(root));
...
static void test_function5_no_root(void **state) {
    (void)state; // Unused
    float root = root_bisection(function5, -2.0, 2.0, 1e-6);
...
static void test_invalid_interval(void **state) {
    (void)state; // Unused
    float root = root_bisection(function2, 1.0, 1.0, 1e-6);
    assert_true(isnan(root));
}
...
static void test_no_sign_change(void **state) {
    (void)state; // Unused
    float root = root_bisection(function2, 2.0, 3.0, 1e-6);
    assert_true(isnan(root));
}
